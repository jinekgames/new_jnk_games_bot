...
400:
'"setglobal param_name param_value\
— (admin 400) добавляет или меняет старую глобальную настройку на заданное значение\
"getglobal param_name\
— (admin 400) показывает значение нужной настройки\
"getallglobal\
— (admin 400) выводит все глобальные настройки',
